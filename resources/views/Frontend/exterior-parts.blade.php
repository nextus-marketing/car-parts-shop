...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime-style-3" data-cursor="-opaque">Exterior Parts</h1>
                        <nav class="wow fadeInUp">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="/">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Exterior Parts</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- Page Header Box End -->
    ...
    <!-- Exterior Parts Section Start -->
    <div class="about-us">
        <div class="container">
            <div class="row">
                <div class="col-xl-6">
                    <!-- Exterior Parts Image Start -->
                    <div class="about-us-image">
                        <figure class="image-anime reveal">
                            <img src="/frontend/images/my-img/main/exterior.jpeg" alt="">
                        </figure>
                    </div>
                    <!-- Exterior Parts Image End -->
                </div>

                <div class="col-xl-6">
                    <!-- Exterior Parts Content Start -->
                    <div class="about-us-content">
                        ...
                        <!-- Exterior Parts Contact Item Start -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="product-item-list">
                        ...
                        <div class="product-item wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <div class="product-item-content">
                                <h2><a href="/exterior-parts/fenders">Fenders</a></h2>
                                <a href="tel:+18556134411" class="btn-default mt-3" contenteditable="false" style="cursor: pointer;">Enquire Now</a>
                            </div>
                        </div>
                        <!-- Product Item End -->
                        ...
                        <div class="product-item wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            <div class="product-item-content">
                                <h2><a href="/exterior-parts/hood/">Hood</a></h2>
                                <a href="tel:+18556134411" class="btn-default mt-3" contenteditable="false" style="cursor: pointer;">Enquire Now</a>
                            </div>
                        </div>
                        <!-- Product Item End -->
                        ...
                        <div class="product-item wow fadeInUp" data-wow-delay="0.8s">
                            ...
                            <div class="product-item-content">
                                <h2><a href="/exterior-parts/mirrors/">Mirrors</a></h2>
                                <a href="tel:+18556134411" class="btn-default mt-3" contenteditable="false" style="cursor: pointer;">Enquire Now</a>
                            </div>
                        </div>
                        <!-- Product Item End -->
                        ...
                        <div class="product-item wow fadeInUp" data-wow-delay="1s">
                            ...
                            <div class="product-item-content">
                                <h2><a href="/exterior-parts/grilles/">Grilles</a></h2>
                                <a href="tel:+18556134411" class="btn-default mt-3" contenteditable="false" style="cursor: pointer;">Enquire Now</a>
                            </div>
                        </div>
                        <!-- Product Item End -->
                        ...
                        <div class="product-item wow fadeInUp" data-wow-delay="1.2s">
                            ...
                            <div class="product-item-content">
                                <h2><a href="/exterior-parts/fender-flare">Fender Flare</a></h2>
                                <a href="tel:+18556134411" class="btn-default mt-3" contenteditable="false" style="cursor: pointer;">Enquire Now</a>
                            </div>
                        </div>
                        <!-- Product Item End -->
                        ...
                        <div class="product-item wow fadeInUp" data-wow-delay="1.2s">
                            <div class="product-item-header">
                                <div class="product-item-image">
                                    <a href="tel:+18556134411">
                                        <figure>
                                            <img src="/frontend/images/my-img/main/wheel_hub.jpg" alt="">
                                        </figure>
                                    </a>
                                </div>
                            </div>
                            <div class="product-item-content">
                                <h2><a href="/exterior-parts/wheel-hub">Wheel Hub</a></h2>
                                <a href="tel:+18556134411" class="btn-default mt-3" contenteditable="false" style="cursor: pointer;">Enquire Now</a>
                            </div>
                        </div>
                        <!-- Product Item End -->
                        ...
                        <div class="product-item wow fadeInUp" data-wow-delay="0.4s">
                            <div class="product-item-header">
                                <div class="product-item-image">
                                    <a href="tel:+18556134411">
                                        <figure>
                                            <img src="/frontend/images/my-img/main/wheel_rim.jpg" alt="">
                                        </figure>
                                    </a>
                                </div>
                            </div>
                            <div class="product-item-content">
                                <h2><a href="/exterior-parts/wheel-rim">Wheel Rim</a></h2>
                                <a href="tel:+18556134411" class="btn-default mt-3" contenteditable="false" style="cursor: pointer;">Enquire Now</a>
                            </div>
                        </div>
                        <!-- Product Item End -->
                ...
                <div class="faqs-content">
                    ...
                    <div class="section-title">
                        ...
                        <h2 class="text-anime-style-3" data-cursor="-opaque">
                            Everything you need to know about our Exterior Parts
                        </h2>

                        <p class="wow fadeInUp" data-wow-delay="0.2s">
                            Find answers to common questions about Exterior Parts,
                    ...
                    <div class="accordion-item wow fadeInUp">
                        ...
                        <h2 class="accordion-header" id="heading1">
                            <button class="accordion-button collapsed"
                                ...
                                01. How do I find the right exterior part for my vehicle?
                        ...
                        <div id="collapse1"
                            ...
                            <div class="accordion-body">
                                <p>
                                    Provide your vehicle's make, model, year, and the exterior
                                    component you need. This information helps identify the correct
                                    exterior part for your vehicle. If you're unsure, our support
                                    team can assist you.
                                </p>
                            </div>
                    ...
                    <div class="accordion-item wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <h2 class="accordion-header" id="heading2">
                            <button class="accordion-button"
                                ...
                                02. What Exterior Parts do you offer?
                        ...
                        <div id="collapse2"
                            ...
                            <div class="accordion-body">
                                <p>
                                    We offer a variety of automotive exterior parts and components,
                                    including bumpers, grilles, fenders, mirrors, door handles,
                                    lights, trim pieces, and other exterior replacement parts
                                    depending on vehicle availability.
                                </p>
                            </div>
                    ...
                    <div class="accordion-item wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <h2 class="accordion-header" id="heading3">
                            <button class="accordion-button collapsed"
                                ...
                                03. How can I check if an exterior part is compatible?
                        ...
                        <div id="collapse3"
                            ...
                            <div class="accordion-body">
                                <p>
                                    ...
                                    body style, and the specific part specifications. Check the
                    ...
                    <div class="accordion-item wow fadeInUp" data-wow-delay="0.6s">
                        ...
                        <h2 class="accordion-header" id="heading4">
                            <button class="accordion-button collapsed"
                                ...
                                04. Can you help me choose the right exterior component?
                        ...
                        <div id="collapse4"
                            ...
                            <div class="accordion-body">
                                <p>
                                    Yes. Our team can help you identify the appropriate exterior
                    ...
                    <div class="accordion-item wow fadeInUp" data-wow-delay="0.8s">
                        ...
                        <h2 class="accordion-header" id="heading5">
                            <button class="accordion-button collapsed"
                                ...
                                05. What if I receive the wrong exterior part?
                        ...
                        <div id="collapse5"
                            ...
                            <div class="accordion-body">
                                <p>
                                    If you receive an incorrect exterior part, contact our
...
<div class="cta-section">
    <div class="container">
        <div class="cta-content">
            <div class="cta-text">
                <span class="section-sub-title">Need Help With Your Exterior Parts?</span>
                <h2>Talk to Our Exterior Parts Experts</h2>
                <p>
                   Have questions about Exterior Parts, compatibility, or finding the right component for your vehicle? Our team is ready to help you identify the right Exterior part and get the best solution for your vehicle.
                </p>
            </div>
