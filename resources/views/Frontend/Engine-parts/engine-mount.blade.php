            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime-style-3" data-cursor="-opaque">Engine Mount</h1>
                        <nav class="wow fadeInUp">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="/">Home</a></li>
                                <li class="breadcrumb-item"><a href="/engine-parts">Engine Parts</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Engine Mount</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- Page Header Box End -->
                ...
                <div class="col-xl-6">
                    ...
                    <div class="about-us-image">
                        <figure class="image-anime reveal">
                            <img src="/frontend/images/my-img/main/engine-mount.jpg" alt="Heavy-Duty Engine Mount Bushing Assembly">
                        </figure>
                    </div>
                ...
                <div class="col-xl-6">
                    ...
                    <div class="about-us-content">
                        ...
                        <div class="section-title">
                            <span class="section-sub-title wow fadeInUp">Vibration Dampening & Engine Stability</span>
                            <h2 class="text-anime-style-3" data-cursor="-opaque">Heavy-Duty Hydraulic & Rubber Engine Mounts</h2>
                            <p class="wow fadeInUp" data-wow-delay="0.2s"><b>Eliminate harsh cabin vibrations, engine clunks, and excessive engine movement with our premium hydraulic and solid rubber motor mount replacements.</b></p>
                            <p class="wow fadeInUp" data-wow-delay="0.4s">Engine mounts securely anchor the engine block to the vehicle chassis while dampening rotational torque and mechanical vibrations. Our inventory features direct-fit hydraulic fluid-filled mounts, durable rubber-to-metal bonded mounts, and high-performance polyurethane mounts. Manufactured to exact OEM geometric tolerances, each mount isolates chassis noise, prevents strain on exhaust manifolds and driveshafts, and restores a smooth, quiet driving experience.</p>
                        </div>
                        <!-- Section Title End -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title text-center wow fadeInUp">
                        ...
                        <h2 class="text-anime-style-3">Our Engine Mount Product Range</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="spec-item">
                        ...
                        <h4>Hydraulic Motor Mounts</h4>
                        <p>Fluid-filled engine mounts designed for luxury and modern passenger vehicles requiring maximum vibration absorption.</p>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="spec-item">
                        ...
                        <h4>Solid Rubber & Steel Mounts</h4>
                        <p>Heavy-duty steel brackets with high-durometer vulcanized rubber core for long-lasting structural rigidity.</p>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="spec-item">
                        ...
                        <h4>Torque Strut & Transmission Mounts</h4>
                        <p>Upper torque strut mounts and transmission support isolators to stabilize engine rotation during acceleration.</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="faqs-content">
                        ...
                        <div class="section-title">
                            ...
                            <p class="wow fadeInUp" data-wow-delay="0.2s">
                                Find answers regarding signs of broken mounts, hydraulic vs solid rubber types, and replacement advice.
                            </p>
                        </div>
                        <!-- Section Title End -->
                        ...
                        <div class="accordion-item wow fadeInUp">
                            <h2 class="accordion-header" id="heading1">
                                <button class="accordion-button collapsed" type="button"
                                    ...
                                    01. How can I tell if my engine mounts are bad or broken?
                                </button>
                            </h2>
                            ...
                            <div id="collapse1"
                                ...
                                <div class="accordion-body">
                                    <p>
                                        Common symptoms include loud clunking or thumping sounds when shifting gears, excessive engine vibration felt through the steering wheel or seat, engine movement when accelerating, and visible cracks or oil leaks on fluid-filled mounts.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="0.2s">
                            <h2 class="accordion-header" id="heading2">
                                <button class="accordion-button" type="button"
                                    ...
                                    02. Should I replace all engine and transmission mounts at the same time?
                                </button>
                            </h2>
                            ...
                            <div id="collapse2"
                                ...
                                <div class="accordion-body">
                                    <p>
                                        Yes, replacing all motor and transmission mounts simultaneously is recommended. A single worn mount places extra strain on the remaining new mounts, causing them to wear out prematurely.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="0.4s">
                            <h2 class="accordion-header" id="heading3">
                                <button class="accordion-button collapsed" type="button"
                                    ...
                                    03. What is the difference between hydraulic and solid rubber motor mounts?
                                </button>
                            </h2>
                            ...
                            <div id="collapse3"
                                ...
                                <div class="accordion-body">
                                    <p>
                                        Hydraulic mounts contain fluid chambers designed to absorb variable frequency engine vibrations for smooth cabin comfort. Solid rubber mounts use solid rubber blocks which are simpler and highly durable for heavy load applications.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="0.6s">
                            <h2 class="accordion-header" id="heading4">
                                <button class="accordion-button collapsed" type="button"
                                    ...
                                    04. Can broken engine mounts cause damage to other car parts?
                                </button>
                            </h2>
                            ...
                            <div id="collapse4"
                                ...
                                <div class="accordion-body">
                                    <p>
                                        Yes! Uncontrolled engine movement can strain exhaust pipes, damage radiator hoses, crack transmission housings, and cause misalignment in driveshafts and linkage cables.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="0.8s">
                            <h2 class="accordion-header" id="heading5">
                                <button class="accordion-button collapsed" type="button"
                                    ...
                                    05. Are mounting bolts included with the replacement mounts?
                                </button>
                            </h2>
                            ...
                            <div id="collapse5"
                                ...
                                <div class="accordion-body">
                                    <p>
                                        Many of our engine mount kits include factory grade mounting studs or hardware. Check specific part details or contact our team for full kit contents.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="1s">
                            <h2 class="accordion-header" id="heading6">
                                <button class="accordion-button collapsed" type="button"
                                    ...
                                    06. How can I locate the right engine mount for my exact car model?
                                </button>
                            </h2>
