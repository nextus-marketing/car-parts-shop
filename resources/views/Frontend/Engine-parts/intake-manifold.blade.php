...
@section('title') OEM & Performance Intake Manifolds | Replacement Air Intake Parts @endsection
@section('content')
<!-- Page Header Start -->
                    ...
                    <div class="faq-accordion" id="accordion">
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="1s">
                            ...
                            <div id="collapse6"
                                ...
                                <div class="accordion-body">
                                    <p>
                                        Call our engine specialists at +1 (888) 370-7485 with your vehicle's VIN, engine displacement, and year to confirm exact manifold specs.
                                    </p>
                                </div>
                            </div>
                        </div>
