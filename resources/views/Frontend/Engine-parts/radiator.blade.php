            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime-style-3" data-cursor="-opaque">Radiator</h1>
                        <nav class="wow fadeInUp">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="/">Home</a></li>
                                <li class="breadcrumb-item"><a href="/engine-parts">Engine Parts</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Radiator</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- Page Header Box End -->
                ...
                <div class="col-xl-6">
                    ...
                    <div class="about-us-image">
                        <figure class="image-anime reveal">
                            <img src="/frontend/images/my-img/main/car-radiator.jpg" alt="High-Performance Car Engine Radiator">
                        </figure>
                    </div>
                ...
                <div class="col-xl-6">
                    ...
                    <div class="about-us-content">
                        ...
                        <div class="section-title">
                            <span class="section-sub-title wow fadeInUp">Maximum Thermal Heat Dissipation</span>
                            <h2 class="text-anime-style-3" data-cursor="-opaque">Aluminum & Plastic Tank Replacement Radiators</h2>
                            <p class="wow fadeInUp" data-wow-delay="0.2s"><b>Keep your engine running at safe operating temperatures with our direct-fit aluminum core replacement radiators designed for domestic, import, and heavy-duty trucks.</b></p>
                            <p class="wow fadeInUp" data-wow-delay="0.4s">The radiator dissipates extreme heat absorbed by coolant circulating through the engine. Over time, plastic end tanks crack, aluminum fins corrode, or internal tubes become clogged with scale. Our high-efficiency radiators feature folded aluminum cooling fins, high-density tube counts, thermal-expansion expansion joints, and leak-tested crimped plastic or full-aluminum end tanks. Each radiator comes complete with built-in transmission oil cooler (TOC) fittings where applicable.</p>
                        </div>
                        <!-- Section Title End -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title text-center wow fadeInUp">
                        ...
                        <h2 class="text-anime-style-3">Our Radiator Range</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="spec-item">
                        ...
                        <h4>OEM Direct-Fit Radiators</h4>
                        <p>Factory-matching core dimensions and mounting points for simple drop-in replacement with standard plastic tanks and aluminum core.</p>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="spec-item">
                        ...
                        <h4>All-Aluminum Performance Radiators</h4>
                        <p>Full 2-row or 3-row TIG-welded aluminum radiators designed for extreme heat dissipation in racing or heavy towing applications.</p>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="spec-item">
                        ...
                        <h4>Integrated Transmission Cooler Units</h4>
                        <p>Built-in concentric copper or aluminum transmission oil heat exchangers ensuring optimal transmission fluid temperature control.</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="faqs-content">
                        ...
                        <div class="section-title">
                            ...
                            <p class="wow fadeInUp" data-wow-delay="0.2s">
                                Read common questions regarding radiator leakage, core clogging, transmission cooler integration, and coolant mixing.
                            </p>
                        </div>
                        <!-- Section Title End -->
                        ...
                        <div class="accordion-item wow fadeInUp">
                            <h2 class="accordion-header" id="heading1">
                                <button class="accordion-button collapsed" type="button"
                                    ...
                                    01. What are the signs of a bad or leaking radiator?
                                </button>
                            </h2>
                            ...
                            <div id="collapse1"
                                ...
                                <div class="accordion-body">
                                    <p>
                                        Key signs include bright green, pink, or orange coolant puddles under the front bumper, temperature gauge rising into the red zone, sweet syrup smells, low coolant levels, and visible cracks along the plastic end tanks.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="0.2s">
                            <h2 class="accordion-header" id="heading2">
                                <button class="accordion-button" type="button"
                                    ...
                                    02. How do I know if the radiator includes an integrated transmission cooler?
                                </button>
                            </h2>
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="0.4s">
                            <h2 class="accordion-header" id="heading3">
                                <button class="accordion-button collapsed" type="button"
                                    ...
                                    03. Is radiator leak stop additive recommended as a permanent fix?
                                </button>
                            </h2>
                            ...
                            <div id="collapse3"
                                ...
                                <div class="accordion-body">
                                    <p>
                                        No, liquid stop-leak additives are only temporary emergency measures. They can clog heater cores and narrow engine cooling passages. Replacing a damaged radiator is the only reliable solution.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="0.6s">
                            <h2 class="accordion-header" id="heading4">
                                <button class="accordion-button collapsed" type="button"
                                    ...
                                    04. Should I replace upper and lower radiator hoses when installing a new radiator?
                                </button>
                            </h2>
                            ...
                            <div id="collapse4"
                                ...
                                <div class="accordion-body">
                                    <p>
                                        Yes, installing new coolant hoses and stainless steel hose clamps prevents old hardened rubber from leaking on the new radiator neck stub.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="0.8s">
                            <h2 class="accordion-header" id="heading5">
                                <button class="accordion-button collapsed" type="button"
                                    ...
                                    05. What ratio of coolant to distilled water should I use?
                                </button>
                            </h2>
                            ...
                            <div id="collapse5"
                                ...
                                <div class="accordion-body">
                                    <p>
                                        A standard 50/50 mix of concentrated antifreeze and distilled water (or pre-mixed 50/50 coolant) provides optimal freeze protection down to -34°F and boil-over protection up to 265°F under pressure.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="1s">
                            <h2 class="accordion-header" id="heading6">
                                <button class="accordion-button collapsed" type="button"
                                    ...
                                    06. How can I ensure 100% fitment for my car?
                                </button>
                            </h2>
