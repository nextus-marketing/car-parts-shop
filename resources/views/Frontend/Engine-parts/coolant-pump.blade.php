            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime-style-3" data-cursor="-opaque">Coolant Pump</h1>
                        <nav class="wow fadeInUp">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="/">Home</a></li>
                                <li class="breadcrumb-item"><a href="/engine-parts">Engine Parts</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Coolant Pump</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- Page Header Box End -->
                ...
                <div class="col-xl-6">
                    ...
                    <div class="about-us-image">
                        <figure class="image-anime reveal">
                            <img src="/frontend/images/my-img/main/coolant_pump.jpg" alt="High-Performance Engine Coolant Water Pump">
                        </figure>
                    </div>
                ...
                <div class="col-xl-6">
                    ...
                    <div class="about-us-content">
                        ...
                        <div class="section-title">
                            <span class="section-sub-title wow fadeInUp">Optimal Engine Thermal Management</span>
                            <h2 class="text-anime-style-3" data-cursor="-opaque">High-Flow Engine Coolant Pumps</h2>
                            <p class="wow fadeInUp" data-wow-delay="0.2s"><b>Protect your engine from dangerous overheating with our high-reliability coolant pumps and water pump assemblies engineered for precise thermal control and durability.</b></p>
                            <p class="wow fadeInUp" data-wow-delay="0.4s">A failing water pump can cause rapid engine overheating, head gasket blowout, and cylinder block warping. Our OEM-quality mechanical and electric coolant pumps feature ceramic unitized seals, anti-cavitation metal impellers, precision-machined housing flanges, and heavy-duty bearing cartridges. Every pump undergoes 100% factory pressure and leak testing to ensure consistent coolant circulation across extreme temperature conditions.</p>
                        </div>
                        <!-- Section Title End -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title text-center wow fadeInUp">
                        ...
                        <h2 class="text-anime-style-3">Our Coolant Pump Range</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="spec-item">
                        ...
                        <h4>Mechanical Belt-Driven Pumps</h4>
                        <p>Standard OEM replacement water pumps driven by serpentine belts or timing belts with high-strength cast housing.</p>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="spec-item">
                        ...
                        <h4>Electric Water Pumps</h4>
                        <p>Modern electronically controlled auxiliary and primary coolant pumps designed for precise variable flow rates in modern engines.</p>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="spec-item">
                        ...
                        <h4>Water Pump & Timing Belt Kits</h4>
                        <p>Complete service bundles including water pump, timing belt, tensioner pulleys, and seals for comprehensive engine maintenance.</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="faqs-content">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="text-anime-style-3" data-cursor="-opaque">
                                Everything you need to know about coolant pumps
                            </h2>

                            <p class="wow fadeInUp" data-wow-delay="0.2s">
                                Read expert answers regarding water pump symptoms, installation timing, coolant flushing, and bearing maintenance.
                            </p>
                        </div>
                        <!-- Section Title End -->
                        ...
                        <div class="accordion-item wow fadeInUp">
                            <h2 class="accordion-header" id="heading1">
                                <button class="accordion-button collapsed" type="button"
                                    ...
                                    01. What are the common symptoms of a failing water pump?
                                </button>
                            </h2>
                            ...
                            <div id="collapse1"
                                ...
                                <div class="accordion-body">
                                    <p>
                                        Symptoms include coolant leaking from the pump weep hole, high engine temperature readings, high-pitched whining noise from worn bearings, steam coming from under the hood, and low coolant level warnings.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="0.2s">
                            <h2 class="accordion-header" id="heading2">
                                <button class="accordion-button" type="button"
                                    ...
                                    02. Should I replace the water pump when replacing the timing belt?
                                </button>
                            </h2>
                            ...
                            <div id="collapse2"
                                ...
                                <div class="accordion-body">
                                    <p>
                                        Yes, on engines where the water pump is driven by the timing belt, it is standard practice to replace both simultaneously. Doing so avoids paying double labor costs if the pump fails shortly after.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="0.4s">
                            <h2 class="accordion-header" id="heading3">
                                <button class="accordion-button collapsed" type="button"
                                    ...
                                    03. Why is coolant flushing recommended when installing a new water pump?
                                </button>
                            </h2>
                            ...
                            <div id="collapse3"
                                ...
                                <div class="accordion-body">
                                    <p>
                                        Old coolant collects rust scale, silica, and debris that can erode internal shaft seals and cause immediate leakage on a new water pump. Fresh coolant protects pump seals and internal passages.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="0.6s">
                            <h2 class="accordion-header" id="heading4">
                                <button class="accordion-button collapsed" type="button"
                                    ...
                                    04. What is the difference between cast iron and aluminum impeller blades?
                                </button>
                            </h2>
                            ...
                            <div id="collapse4"
                                ...
                                <div class="accordion-body">
                                    <p>
                                        Metallic impellers (cast iron or stamped steel) provide superior resistance to high-temperature thermal distortion and chemical breakdown compared to cheap plastic/composite impellers.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="0.8s">
                            <h2 class="accordion-header" id="heading5">
                                <button class="accordion-button collapsed" type="button"
                                    ...
                                    05. Do your coolant pumps include mounting gaskets or O-rings?
                                </button>
                            </h2>
                            ...
                            <div id="collapse5"
                                ...
                                <div class="accordion-body">
                                    <p>
                                        Yes, all our coolant pump assemblies come supplied with factory-correct rubber O-rings or molded housing gaskets necessary for a leak-free installation.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="1s">
                            <h2 class="accordion-header" id="heading6">
                                <button class="accordion-button collapsed" type="button"
                                    ...
                                    06. How can I confirm the correct water pump part number for my vehicle?
                                </button>
                            </h2>
