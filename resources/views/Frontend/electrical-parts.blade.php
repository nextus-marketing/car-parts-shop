...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime-style-3" data-cursor="-opaque">Electrical Parts</h1>
                        <nav class="wow fadeInUp">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="/">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Electrical Parts</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- Page Header Box End -->
    ...
    <!-- Electrical Parts Section Start -->
    <div class="about-us">
        <div class="container">
            <div class="row">
                <div class="col-xl-6">
                    <!-- Electrical Parts Image Start -->
                    <div class="about-us-image">
                        <figure class="image-anime reveal">
                            <img src="/frontend/images/my-img/main/car-electrical-aprts.avif" alt="">
                        </figure>
                    </div>
                    <!-- Electrical Parts Image End -->
                </div>

                <div class="col-xl-6">
                    <!-- Electrical Parts Content Start -->
                    <div class="about-us-content">
                        ...
                        <!-- Electrical Parts Contact Item Start -->
                        ...
                        <!-- Electrical Parts Contact Item End -->
                    </div>
                    <!-- Electrical Parts Content End -->
                </div>
            </div>
        </div>
    </div>
    <!-- Electrical Parts Section End -->
                            ...
                            <div class="product-item-header">
                                <div class="product-item-image">
                                    <a href="tel:+18556134411">
                                        <figure>
                                            <img src="/frontend/images/my-img/main/alternators.jpg" alt="">
                                        </figure>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="product-item wow fadeInUp" data-wow-delay="0.2s">
                            <div class="product-item-header">
                                <div class="product-item-image">
                                    <a href="tel:+18556134411">
                                        <figure>
                                            <img src="/frontend/images/my-img/main/car_starter.jpg" alt="">
                                        </figure>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="product-item wow fadeInUp" data-wow-delay="0.6s">
                            <div class="product-item-header">
                                <div class="product-item-image">
                                    <a href="tel:+18556134411">
                                        <figure>
                                            <img src="/frontend/images/my-img/main/fuse_box.jpg" alt="">
                                        </figure>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="product-item wow fadeInUp" data-wow-delay="0.8s">
                            <div class="product-item-header">
                                <div class="product-item-image">
                                    <a href="tel:+18556134411">
                                        <figure>
                                            <img src="/frontend/images/my-img/main/car_instrument.jpg" alt="">
                                        </figure>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="product-item wow fadeInUp" data-wow-delay="1s">
                            <div class="product-item-header">
                                <div class="product-item-image">
                                    <a href="tel:+18556134411">
                                        <figure>
                                            <img src="/frontend/images/my-img/main/wiper-motor.jpg" alt="">
                                        </figure>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="product-item wow fadeInUp" data-wow-delay="1.2s">
                            <div class="product-item-header">
                                <div class="product-item-image">
                                    <a href="tel:+18556134411">
                                        <figure>
                                            <img src="/frontend/images/my-img/main/window_motor_regulator.jpg" alt="">
                                        </figure>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="product-item wow fadeInUp" data-wow-delay="1.2s">
                            <div class="product-item-header">
                                <div class="product-item-image">
                                    <a href="tel:+18556134411">
                                        <figure>
                                            <img src="/frontend/images/my-img/main/cd_player_radio.jpg" alt="">
                                        </figure>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="product-item wow fadeInUp" data-wow-delay="0.4s">
                            <div class="product-item-header">
                                <div class="product-item-image">
                                    <a href="tel:+18556134411">
                                        <figure>
                                            <img src="/frontend/images/my-img/main/tail_light.jpg" alt="">
                                        </figure>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="product-item wow fadeInUp" data-wow-delay="0.8s">
                            <div class="product-item-header">
                                <div class="product-item-image">
                                    <a href="tel:+18556134411">
                                        <figure>
                                            <img src="/frontend/images/my-img/main/fog_lamps.jpg" alt="">
                                        </figure>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="product-item wow fadeInUp" data-wow-delay="1s">
                            <div class="product-item-header">
                                <div class="product-item-image">
                                    <a href="tel:+18556134411">
                                        <figure>
                                            <img src="/frontend/images/my-img/main/abs_unit.jpg" alt="">
                                        </figure>
                                    </a>
                                </div>
                            </div>
                ...
                <div class="faqs-content">
                    ...
                    <div class="section-title">
                        ...
                        <h2 class="text-anime-style-3" data-cursor="-opaque">
                            Everything you need to know about our Electrical Parts
                        </h2>

                        <p class="wow fadeInUp" data-wow-delay="0.2s">
                            Find answers to common questions about electrical parts,
                    ...
                    <div class="accordion-item wow fadeInUp">
                        ...
                        <h2 class="accordion-header" id="heading1">
                            <button class="accordion-button collapsed"
                                ...
                                01. How do I find the right electrical part for my vehicle?
                        ...
                        <div id="collapse1"
                            ...
                            <div class="accordion-body">
                                <p>
                                    Provide your vehicle's make, model, year, and the electrical
                                    component you need. This information helps identify the correct
                                    electrical part for your vehicle. If you're unsure, our support
                                    team can assist you.
                                </p>
                            </div>
                    ...
                    <div class="accordion-item wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <h2 class="accordion-header" id="heading2">
                            <button class="accordion-button"
                                ...
                                02. What Electrical Parts do you offer?
                        ...
                        <div id="collapse2"
                            ...
                            <div class="accordion-body">
                                <p>
                                    We offer a variety of automotive electrical parts and
                                    components, including sensors, switches, wiring components,
                                    relays, starters, alternators, lighting components, and other
                                    electrical replacement parts depending on vehicle availability.
                                </p>
                            </div>
                    ...
                    <div class="accordion-item wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <h2 class="accordion-header" id="heading3">
                            <button class="accordion-button collapsed"
                                ...
                                03. How can I check if an electrical part is compatible?
                        ...
                        <div id="collapse3"
                            ...
                            <div class="accordion-body">
                                <p>
                                    ...
                                    engine, electrical system, and part specifications. Check the
                                    product details or contact our support team with your vehicle
                    ...
                    <div class="accordion-item wow fadeInUp" data-wow-delay="0.6s">
                        ...
                        <h2 class="accordion-header" id="heading4">
                            <button class="accordion-button collapsed"
                                ...
                                04. Can you help me choose the right electrical component?
                        ...
                        <div id="collapse4"
                            ...
                            <div class="accordion-body">
                                <p>
                                    Yes. Our team can help you identify the appropriate electrical
                                    component based on your vehicle details and the electrical
                                    system or part you need. Contact us with your vehicle
                    ...
                    <div class="accordion-item wow fadeInUp" data-wow-delay="0.8s">
                        ...
                        <h2 class="accordion-header" id="heading5">
                            <button class="accordion-button collapsed"
                                ...
                                05. What if I receive the wrong electrical part?
                        ...
                        <div id="collapse5"
                            ...
                            <div class="accordion-body">
                                <p>
                                    If you receive an incorrect electrical part, contact our
...
<div class="cta-section">
    <div class="container">
        <div class="cta-content">
            <div class="cta-text">
                <span class="section-sub-title">Need Help With Your Electrical Parts?</span>
                <h2>Talk to Our Electrical Parts Experts</h2>
                <p>
                   Have questions about Electrical Parts, compatibility, or finding the right component for your vehicle? Our team is ready to help you identify the right electrical part and get the best solution for your vehicle.
                </p>
            </div>
