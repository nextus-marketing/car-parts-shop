...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime-style-3" data-cursor="-opaque">Suspension Parts</h1>
                        <nav class="wow fadeInUp">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="/">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Suspension Parts</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- Page Header Box End -->
    ...
    <!-- Suspension Parts Section Start -->
    <div class="about-us">
        <div class="container">
            <div class="row">
                <div class="col-xl-6">
                ...
                <div class="col-xl-6">
                    <!-- Suspension Parts Content Start -->
                    <div class="about-us-content">
                        ...
                        <!-- Suspension Parts Contact Item Start -->
                        ...
                        <!-- Suspension Parts Contact Item End -->
                    </div>
                    <!-- Suspension Parts Content End -->
                </div>
            </div>
        </div>
    </div>
    <!-- Suspension Parts Section End -->
                        ...
                        <div class="product-item wow fadeInUp" data-wow-delay="0.2s">
                            <div class="product-item-header">
                                <div class="product-item-image">
                                    <a href="tel:+18556134411">
                                        <figure>
                                            <img src="/frontend/images/my-img/main/rack_and_pinion.jpg" alt="">
                                        </figure>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="product-item wow fadeInUp" data-wow-delay="0.4s">
                            <div class="product-item-header">
                                <div class="product-item-image">
                                    <a href="tel:+18556134411">
                                        <figure>
                                            <img src="/frontend/images/my-img/main/control_arms.jpg" alt="">
                                        </figure>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="product-item wow fadeInUp" data-wow-delay="0.6s">
                            <div class="product-item-header">
                                <div class="product-item-image">
                                    <a href="tel:+18556134411">
                                        <figure>
                                            <img src="/frontend/images/my-img/main/braker_caliper.jpg" alt="">
                                        </figure>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="product-item wow fadeInUp" data-wow-delay="0.8s">
                            <div class="product-item-header">
                                <div class="product-item-image">
                                    <a href="tel:+18556134411">
                                        <figure>
                                            <img src="/frontend/images/my-img/main/power_steering_pump.jpg" alt="">
                                        </figure>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="product-item wow fadeInUp" data-wow-delay="1s">
                            <div class="product-item-header">
                                <div class="product-item-image">
                                    <a href="tel:+18556134411">
                                        <figure>
                                            <img src="/frontend/images/my-img/main/steering_column.jpg" alt="">
                                        </figure>
                                    </a>
                                </div>
                            </div>
                ...
                <div class="faqs-content">
                    ...
                    <div class="section-title">
                        ...
                        <h2 class="text-anime-style-3" data-cursor="-opaque">
                            Everything you need to know about our Suspension Parts
                        </h2>

                        <p class="wow fadeInUp" data-wow-delay="0.2s">
                            Find answers to common questions about suspension parts,
                    ...
                    <div class="accordion-item wow fadeInUp">
                        ...
                        <h2 class="accordion-header" id="heading1">
                            <button class="accordion-button collapsed"
                                ...
                                01. How do I find the right suspension part for my vehicle?
                        ...
                        <div id="collapse1"
                            ...
                            <div class="accordion-body">
                                <p>
                                    Provide your vehicle's make, model, year, and suspension
                                    specifications to help identify the correct suspension part.
                                    If you're unsure, our support team can help you find the
                                    right component.
                                </p>
                            </div>
                    ...
                    <div class="accordion-item wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <h2 class="accordion-header" id="heading2">
                            <button class="accordion-button"
                                ...
                                02. What suspension parts do you offer?
                        ...
                        <div id="collapse2"
                            ...
                            <div class="accordion-body">
                                <p>
                                    We offer a range of suspension components and replacement
                                    parts for different vehicle applications. Available parts
                                    may vary depending on your vehicle and suspension system.
                                </p>
                            </div>
                    ...
                    <div class="accordion-item wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <h2 class="accordion-header" id="heading3">
                            <button class="accordion-button collapsed"
                                ...
                                03. How can I check if a suspension part is compatible?
                        ...
                        <div id="collapse3"
                            ...
                            <div class="accordion-body">
                                <p>
                                    ...
                                    suspension type, and part specifications. Check the product
                                    details or contact our support team with your vehicle
                    ...
                    <div class="accordion-item wow fadeInUp" data-wow-delay="0.6s">
                        ...
                        <h2 class="accordion-header" id="heading4">
                            <button class="accordion-button collapsed"
                                ...
                                04. Can you help me choose the right suspension component?
                        ...
                        <div id="collapse4"
                            ...
                            <div class="accordion-body">
                                <p>
                                    Yes. Our team can help you identify the right suspension
                                    component based on your vehicle details and the part you
                                    need. Contact us with your vehicle information for assistance.
                                </p>
                            </div>
                    ...
                    <div class="accordion-item wow fadeInUp" data-wow-delay="0.8s">
                        ...
                        <h2 class="accordion-header" id="heading5">
                            <button class="accordion-button collapsed"
                                ...
                                05. What if I receive the wrong suspension part?
                        ...
                        <div id="collapse5"
                            ...
                            <div class="accordion-body">
                                <p>
                                    If you receive an incorrect suspension part, contact our
...
<div class="cta-section">
    <div class="container">
        <div class="cta-content">
            <div class="cta-text">
                <span class="section-sub-title">Need Help With Your Suspension Parts?</span>
                <h2>Talk to Our Suspension Parts Experts</h2>
                <p>
                   Have questions about Suspension Parts, compatibility, or finding the right component for your vehicle? Our team is ready to help you identify the right suspension part and get the best solution for your vehicle.
                </p>
            </div>
