            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime-style-3" data-cursor="-opaque"> Cradle</h1>
                        <nav class="wow fadeInUp">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="/">Home</a></li>
                                <li class="breadcrumb-item"><a href="/transmission-parts">Transmission Parts</a></li>
                                <li class="breadcrumb-item active" aria-current="page"> Cradle</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- Page Header Box End -->
                ...
                <div class="col-xl-6">
                    ...
                    <div class="about-us-image">
                        <figure class="image-anime reveal">
                            <img src="/frontend/images/my-img/main/cradle.jpg" alt="OEM Heavy-Duty Engine Cradle Subframe">
                        </figure>
                    </div>
                ...
                <div class="col-xl-6">
                    ...
                    <div class="about-us-content">
                        ...
                        <div class="section-title">
                            <span class="section-sub-title wow fadeInUp">Transmission Support & Front Chassis Rigidity</span>
                            <h2 class="text-anime-style-3" data-cursor="-opaque">OEM Heavy-Gauge Steel Transmission Cradles</h2>
                            <p class="wow fadeInUp" data-wow-delay="0.2s"><b>Restore structural chassis squareness, engine mount alignment, and suspension mounting rigidity with our rust-free OEM engine cradles.</b></p>
                            <p class="wow fadeInUp" data-wow-delay="0.4s">The Transmission cradle (front subframe crossmember) acts as the heavy structural foundation under your vehicle's engine bay. It supports the engine assembly, transmission transaxle, lower control arms, steering rack, and anti-roll bar. Severe curb collisions or road salt rust perforation weaken cradle mounting points, causing wheel alignment wander and engine sagging. Our replacement cradles are inspected for zero frame twist, pre-primed, and feature factory bushing sleeves.</p>
                        </div>
                        <!-- Section Title End -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title text-center wow fadeInUp">
                        ...
                        <h2 class="text-anime-style-3">Our Engine Cradle Product Range</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="spec-item">
                        ...
                        <h4>OEM Front Engine & Transaxle Cradles</h4>
                        <p>Rust-free structural steel front subframe cradles engineered to OEM mounting hole alignment specs.</p>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="spec-item">
                        ...
                        <h4>Hydroformed Tubular Subframes</h4>
                        <p>Lightweight hydroformed steel and aluminum suspension cradles for modern unibody vehicles.</p>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="spec-item">
                        ...
                        <h4>Cradle Rubber Insulator Bushings</h4>
                        <p>Replacement subframe body mount rubber vibration dampers to isolate engine vibration from the passenger cabin.</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="faqs-content">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="text-anime-style-3" data-cursor="-opaque">
                                Everything you need to know about engine cradles
                            </h2>

                            <p class="wow fadeInUp" data-wow-delay="0.2s">
                                Read common questions about subframe rust replacement, engine support hoist setup, alignment pin positioning, and fitment.
                            </p>
                        </div>
                        <!-- Section Title End -->
                        ...
                        <div class="accordion-item wow fadeInUp">
                            <h2 class="accordion-header" id="heading1">
                                <button class="accordion-button collapsed" type="button"
                                    ...
                                    01. What are the signs of a rusted or bent engine cradle?
                                </button>
                            </h2>
                            ...
                            <div id="collapse1"
                                ...
                                <div class="accordion-body">
                                    <p>
                                        Symptoms include severe steering alignment pull that cannot be adjusted, engine motor mount bolts snapping, deep rust holes around control arm mounts, and clunking during braking.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="0.2s">
                            <h2 class="accordion-header" id="heading2">
                                <button class="accordion-button" type="button"
                                    ...
                                    02. Is an engine support bridge required when replacing the front cradle?
                                </button>
                            </h2>
                            ...
                            <div id="collapse2"
                                ...
                                <div class="accordion-body">
                                    <p>
                                        Yes! An engine support bar mounted across the upper inner fender lip is required to hold the weight of the engine and transmission from above while unbolting the lower cradle subframe.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="0.4s">
                            <h2 class="accordion-header" id="heading3">
                                <button class="accordion-button collapsed" type="button"
                                    ...
                                    03. Are subframe alignment dowel pins used during installation?
                                </button>
                            </h2>
                            ...
                            <div id="collapse3"
                                ...
                                <div class="accordion-body">
                                    <p>
                                        Yes, factory cradle mounting bolt holes feature alignment pin guide holes to ensure the subframe bolts up perfectly square to the unibody chassis.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="0.6s">
                            <h2 class="accordion-header" id="heading4">
                                <button class="accordion-button collapsed" type="button"
                                    ...
                                    04. Do replacement engine cradles include control arms and steering rack mounts?
                                </button>
                            </h2>
                            ...
                            <div id="collapse4"
                                ...
                                <div class="accordion-body">
                                    <p>
                                        Engine cradles feature welded bracket provisions for steering racks, sway bar bushings, and control arms. Original or new suspension components bolt directly onto the cradle frame.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item wow fadeInUp" data-wow-delay="0.8s">
                            <h2 class="accordion-header" id="heading5">
                                <button class="accordion-button collapsed" type="button"
                                    ...
                                    05. How are heavy engine cradles shipped safely?
                                </button>
                            </h2>
                            ...
                            <div id="collapse5"
                                ...
                                <div class="accordion-body">
                                    <p>
                                        Engine cradles are strapped flat onto wooden freight pallets and wrapped in protective film, shipped via commercial LTL freight trucks directly to your shop.
                                    </p>
                                </div>
                            </div>
                        </div>
